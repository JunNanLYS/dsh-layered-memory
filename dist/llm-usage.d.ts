...
export declare function recordDistillCall(layer: DistillLayer, inputChars: number, outputTokens: number, reasoningTokens: number, failed: boolean): void;
/** 深拷贝快照（消费方拿到后不受后续累计影响）。 */
export declare function snapshotDistillUsage(): DistillUsageSnapshot;
